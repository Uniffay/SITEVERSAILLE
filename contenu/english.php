...
define("contenu5_mention","Our Versailles site is operated in compliance with French legislation. Use of this site is governed by these terms and conditions. By using the site, you recognize to have taken knowledge of these conditions and to have accepted them. These may be modified at any time and without notice by our Team.");
define("limi_resp","Limitation of responsibility");
define("contenu6_mention","The information contained on this site is as accurate as possible, but may contain inaccuracies, omissions or gaps. If you notice a gap, error or what appears to be a malfunction, please report it by email describing the problem as precisely as possible (page causing the problem, action triggered, type of computer and browser used, ...).");
define("contenu7_mention","Any downloaded content is done at the user's own risk and under his sole responsibility. Consequently, our Team cannot be held responsible for any damage to the user's computer or any loss of data resulting from downloading.  ");
define("privacy","Privacy");
define("contenu8_mention","Your personal data are confidential and will not be communicated to third parties under any circumstances except for the proper execution of the service.");
define("propri_inte","Intellectual Property");
define("contenu9_mention","All content on this site, including, but not limited to, images, text, animations, and icons, as well as their formatting, are the exclusive property of our Team.");
define("contenu10_mention","Any reproduction, distribution, modification, adaptation, retransmission or publication, even partial, of these various elements is strictly prohibited without the express written consent of our Team. This representation or reproduction, by any process whatsoever, constitutes an infringement punishable by articles L.335-2 and following of the Intellectual Property Code. Failure to comply with this prohibition constitutes an infringement that may result in the civil and criminal liability of the offender. In addition, the owners of the copied Content may take legal action against you.");
define("contenu11_mention","Our Team is identically the owner of the 'rights of database producers' referred to in Book III, Title IV, of the Intellectual Property Code (law no. 98-536 of July 1, 1998) relating to copyright and databases.");
